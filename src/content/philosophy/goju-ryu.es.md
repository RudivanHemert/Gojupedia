...
* **Go:** Representa lo "duro" o "externo". Este aspecto implica técnicas de mano cerrada, movimientos lineales directos y la aplicación de fuerza física.
* **Ju:** Representa lo "suave" o "interno". Este aspecto enfatiza técnicas de mano abierta, movimientos circulares y el desarrollo del *chi* (energía vital).

El estilo fue nombrado formalmente por su fundador, Chojun Miyagi Sensei. Extrajo los términos "Go" y "Ju" de una línea del *Bubishi*, un texto clásico chino de artes marciales, específicamente del Kenpo Haku (Ocho Poemas del Puño): *"Ho Go Ju donto"*, que se traduce como "La forma de inhalar y exhalar es dureza y suavidad".
