...
6. **Ushiro Ura Mawashi Geri** - Spinning kick
...
1. **De Ashi Barai** - Undercut from side behind foot
 - Sweeping technique targeting the opponent's foot

2. **Kuzushi** - Undercut from side of both legs
 - Technique to break opponent's balance

3. **O Soto Gari** - Large external undercut
 - Major outer reaping throw

4. **O Uchi Gari** - Large internal undercut
 - Major inner reaping throw

5. **Ko Soto Gari** - Small external undercut
 - Minor outer reaping throw

6. **Ko Uchi Gari** - Small internal undercut
 - Minor inner reaping throw

7. **Okuri Ashi Harai** - Undercut by leaning
 - Sweeping technique using body weight

8. **Tai-otoshi** - Throw by lowering
