...
const equipmentId = 'kongoken';
// Using 'exercises' as the primary key since it contains most merged text
const sectionKey = 'exercises'; 

const KongokenExercises = () => {
  const equipment = hojoUndoData[equipmentId];
  // Also get classic exercises if available
        ...
        <div className="prose prose-stone dark:prose-invert max-w-none">
          {section.content.map((item, index) => {
            if (item.startsWith('BULLET: ')) {
              ...
              return <p key={index} className="ml-8">{item.substring(14)}</p>; 
            }
...
export default KongokenExercises; 