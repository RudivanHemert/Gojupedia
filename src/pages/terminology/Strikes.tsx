...
const StrikesContent = () => {
  const { t } = useTranslation();
  const termsObject = t('terminology.sections.strikes-content.terms', { returnObjects: true }) as Record<string, { name: string; japanese?: string; english: string }>;
