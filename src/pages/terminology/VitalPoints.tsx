  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="space-y-8">
        <section>
          <h2 className="text-2xl font-bold mb-4">Interactive Diagram</h2>
          <InteractiveVitalPoints />
        </section>

        <section>
          <h2 className="text-2xl font-bold mb-4">Vital Points Reference</h2>
          <Accordion type="multiple" className="w-full space-y-4">
            <AccordionItem value="front-view">
              <AccordionTrigger>Front View Points</AccordionTrigger>
              <AccordionContent>
            ...
            <AccordionItem value="back-view">
              <AccordionTrigger>Back View Points</AccordionTrigger>
              <AccordionContent>
                <div className="grid gap-2 p-4">
