...
const DojoTermsContent = () => {
  const { t } = useTranslation();
  const termsObject = t('terminology.sections.dojo-terms-content.terms', { returnObjects: true }) as Record<string, { name: string; japanese?: string; english: string }>;

  return (
    <div className="space-y-6">
      <p className="text-muted-foreground">
        {t('terminology.sections.dojo-terms-content.description')}
      </p>
