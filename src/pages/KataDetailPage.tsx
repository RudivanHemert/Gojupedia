...
import { saifaSteps as saifaStepsPt } from '@/data/saifa.pt';
...
import { seiyunchinSteps as seiyunchinStepsPt } from '@/data/seiyunchin.pt';
                ...
                <CardContent className="pt-6">
                  ...
                  <div className="aspect-video bg-muted rounded overflow-hidden">
                    <iframe
                      ...
                      loading="lazy"
                    >
                      <p>{t('kataDetailPage.video.browserNotSupported')} <a href={kata.videoUrl} target="_blank" rel="noopener noreferrer">{t('kataDetailPage.video.watchOnYouTube')}</a></p>
                    </iframe>
                  </div>
                </CardContent>
              </Card>
