...
const MindBody = () => {
 ...
 <Card>
 <CardHeader>
 <CardTitle>Shin Shin Ichinyo</CardTitle>
 </CardHeader>
 <CardContent>
 ...
 <h3 className="font-semibold text-purple-800 mb-2">Geest</h3>
 ...
 <h3 className="font-semibold text-green-800 mb-2">Lichaam</h3>
