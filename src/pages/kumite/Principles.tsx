...
const mentalPrinciples = [
 { id: 'zanshin', icon: Eye, name: 'Zanshin - Overblijvende Geest' },
 { id: 'mushin', icon: Brain, name: 'Mushin - Geest Zonder Gedachten' },
 { id: 'fudoshin', icon: Shield, name: 'Fudoshin - Onbeweeglijke Geest' },
 { id: 'senshin', icon: Eye, name: 'Senshin - Gepurificeerde Geest' }
];

const tacticalPrinciples = [
 { id: 'ma-ai', icon: Target, name: 'Ma-ai - Vechtafstand' },
 { id: 'sen', icon: Zap, name: 'Sen - Initiatief' },
 { id: 'go-no-sen', icon: Clock, name: 'Go No Sen - Reactie op Aanval' },
 { id: 'sen-no-sen', icon: Target, name: 'Sen No Sen - Aanvallen van de Aanval' }
];
