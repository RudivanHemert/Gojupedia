...
const KumiteCompetition = () => {
  const { t } = useTranslation();
  const content = useMarkdownContent('kumite/competition');

  return (
    <div className="min-h-screen bg-white">
      <TheoryHeader 
        title={t('kumite.competition.title')}
        description={t('kumite.competition.organizations')}
        backUrl="/kumite"
      />
      <div className="p-4">
...
export default KumiteCompetition; 