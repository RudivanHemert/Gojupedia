  ...
  const mainSections = [
    {
      id: 'theory',
      title: 'Theory',
      subtitle: 'Philosophy, history, terminology and kata theory',
    ...
    },
    {
      id: 'practice',
      title: 'Practice',
      subtitle: 'Techniques, kata, bunkai, kumite and hojo undo',
    ...
    },
    {
      id: 'study',
      title: 'Study',
      subtitle: 'Quizzes, flashcards and graduations',
    ...
    },
    {
      id: 'search',
      title: 'Search',
      subtitle: 'Search through all content and terms',
    ...
    },
    {
      id: 'about',
      title: 'About',
      subtitle: 'About Gojupedia and Goju Ryu Karate',
    ...
    <div className="flex flex-col w-full min-h-screen bg-background">
      <div className="flex flex-col w-full mt-0 px-0">
        ...
        <div className="flex flex-col items-center mb-8">
          ...
          <div className="text-base text-muted-foreground dark:text-stone-400 mb-4">Strength and fluidity in movement</div>
        </div>
        ...
        <div className="bg-card dark:bg-card rounded-none shadow-none p-4 sm:p-6 md:p-8 mb-6 w-full text-center">
          ...
          <div className="text-lg text-foreground leading-relaxed">
            Gojupedia is your comprehensive resource for learning and understanding Goju-Ryu Karate. Whether you're a beginner or advanced practitioner, you'll find everything you need here.
          </div>
        </div>

        {/* Main sections */}
        <div className="w-full mb-6">
          <h3 className="text-xl font-bold mb-4 text-center">Main Sections</h3>
        ...
        {/* Popular subsections */}
        <div className="w-full mb-6">
          <h3 className="text-xl font-bold mb-4 text-center">Popular Subsections</h3>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-2 sm:gap-3 px-2 sm:px-4 md:px-6">
            ...
            >
              ...
              <span className="font-medium text-sm">Philosophy</span>
            </Link>
            <Link
              to="/techniques"
              className="bg-card dark:bg-card rounded-lg shadow flex items-center px-4 py-3 hover:bg-muted/50 transition group"
            ...
            >
              ...
              <span className="font-medium text-sm">Terminology</span>
            </Link>
          </div>
        </div>
        ...
        <div className="w-full flex flex-col items-center mt-6 mb-6 px-2 sm:px-4 md:px-6">
          <div className="italic text-muted-foreground text-center w-full md:max-w-3xl mb-2 text-lg">
            "Karate is not just a martial art, but a path to improve one's character"
          </div>
          <div className="text-muted-foreground text-sm">- Chojun Miyagi</div>
        </div>
      </div>
    </div>
  );
