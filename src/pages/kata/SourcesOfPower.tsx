    ...
    <ScrollArea className="h-[calc(100vh-14rem)] pr-4">
      <div className="space-y-4">
        <section className="space-y-2">
          <h2 className="text-xl font-bold">Sources of Power</h2>
          <p>
          ...
          <h3 className="text-lg font-semibold mt-4">Power from the Ground (Push-off Force)</h3>
          <p>
          ...
          <h3 className="text-lg font-semibold mt-4">Discharging Power (Discharge or Spring Power)</h3>
          <p>
          ...
          <h3 className="text-lg font-semibold mt-4">Power through Gravity</h3>
          <p>
