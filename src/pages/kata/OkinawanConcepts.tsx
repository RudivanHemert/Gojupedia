    ...
    <ScrollArea className="h-[calc(100vh-14rem)] pr-4">
      <div className="space-y-4">
        <section className="space-y-2">
          <h2 className="text-xl font-bold">Six Okinawan Concepts</h2>
          <p>
          ...
          <Accordion type="single" collapsible className="w-full mt-4">
            <AccordionItem value="chinkuchi-kakin">
              <AccordionTrigger className="text-lg font-semibold">Chinkuchi Kakin (Kime)</AccordionTrigger>
            ...
            <AccordionItem value="muchimi">
              <AccordionTrigger className="text-lg font-semibold">Muchimi</AccordionTrigger>
              <AccordionContent className="space-y-2 text-base">
                <p>
            ...
            <AccordionItem value="chiru-no-chan-chan">
              <AccordionTrigger className="text-lg font-semibold">Chiru No Chan Chan</AccordionTrigger>
              <AccordionContent className="space-y-2 text-base">
                <p>
            ...
            <AccordionItem value="chikara-nu-nujisashi">
              <AccordionTrigger className="text-lg font-semibold">Chikara Nu Nujisashi</AccordionTrigger>
              <AccordionContent className="space-y-2 text-base">
                <p>
            ...
            <AccordionItem value="te-no-omomi">
              <AccordionTrigger className="text-lg font-semibold">Te No Omomi</AccordionTrigger>
              <AccordionContent className="space-y-2 text-base">
                <p>
            ...
            <AccordionItem value="shimeijurasan">
              <AccordionTrigger className="text-lg font-semibold">Shimeijurasan</AccordionTrigger>
              <AccordionContent className="space-y-2 text-base">
                <p>
