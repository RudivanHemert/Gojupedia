    ...
    <ScrollArea className="h-[calc(100vh-14rem)] pr-4">
      <div className="space-y-4">
        <section className="space-y-2">
          <h2 className="text-xl font-bold">Transferring and Processing Power</h2>
          <p>
          ...
          <Tabs defaultValue="strikes-punches" className="w-full mt-4">
            <TabsList className="grid grid-cols-3 mb-4">
              <TabsTrigger value="strikes-punches">Strikes & Punches</TabsTrigger>
              <TabsTrigger value="kicks">Kicks</TabsTrigger>
              <TabsTrigger value="blocks-evasions">Blocks & Evasions</TabsTrigger>
            </TabsList>
            
            <TabsContent value="strikes-punches" className="space-y-3">
              <h3 className="text-lg font-semibold">Strikes and Punches</h3>
              <p>
            ...
            <TabsContent value="kicks" className="space-y-3">
            ...
            <TabsContent value="blocks-evasions" className="space-y-3">
              <h3 className="text-lg font-semibold">Blocks and Evasions</h3>
              <p>
