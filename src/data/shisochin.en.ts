...
export const shisochinSteps: KataStep[] = [
  {
    id: 'step-1',
    number: 1,
    title: 'Introduction and meaning of Shisochin',
    description: `Shisochin was introduced to Okinawa by Kanryo Higaonna. He learned the kata from Ryu Ryu Ko. The original creator of the kata is unknown. Shisochin means "four openings" or "four directions" and this refers to the execution of shotei zuki (palm strike) in four directions.

Goju-ryu is the only karate style with this kata. The kata is characterized by many and powerful open hand techniques. An arm with an open hand can be relaxed more easily than with a fist, allowing techniques to be executed faster.`,
  },
  {
    id: 'step-2',
    number: 2,
    title: 'Nukite zuki and morote chudan shotei uke',
    description: `From musubi dachi, sink down and step with a circular movement with the right leg into sanchin dachi (feet stand, as in all kaishugata, straight). Simultaneously, the hands go up, slide over each other at the level of the solar plexus to the side and make a circular movement forward past the elbows into morote chudan shotei uke.

The hands are more vertical than horizontal. The elbows are close to the body (about a fist away) and make a 90-degree angle. During movement, blocking and striking, you should imagine a tiger stalking its prey and then suddenly pouncing.`,
  },
  {
    id: 'step-3',
    number: 3,
    title: 'Nukite zuki execution',
    description: `So you move slowly, circularly (ankle along ankle) and with muchimi. If you are grounded, you suddenly strike with a nukite zuki with much power, speed and precision. The hand that is going to strike is first pulled back forcefully into your side, then it springs out.
...
The ude osae is initiated from the push-off of the leg and hips, the shoulders and hips move together, make sure you don't use muscle power from your shoulders or arms. The head initially turns with the body but keeps looking forward.`,
  },
  {
    ...
    description: `Bring your weight to your left foot and close both feet together (heisoku dachi). Of course, this is a practice stance to gain more balance. During the movement to heisoku dachi, you inhale and close your pelvis by tilting it backward.
