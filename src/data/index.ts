...
export const katas: Kata[] = [
 ...
 videoUrl: "https://www.youtube.com/watch?v=NQG5Ua-zHDk",
...
const generateStudiesFromTechniques = (categories: readonly TerminologyCategory[], t: (key: string, options?: any) => string): Study[] => {
 ...
 explanation: term.details || t('study.noAdditionalExplanation', 'No additional explanation available.')
 };
 });
...
export const buildStudies = (t: (key: string, options?: any) => string): Study[] => {
 ...
 defaultValue: t('study.noAdditionalExplanation', 'No additional explanation available.')
 })
 }))
 });
 }
 ...
 questions: [
 { id: "kata-sanchin", question: "Sanchin", correctAnswer: t("studyTerminology.kata.sanchin.english", "Three Battles"), explanation: t("studyTerminology.kata.sanchin.explanation", "Represents mind, body, and spirit - the foundation kata") },
 { id: "kata-tensho", question: "Tensho", correctAnswer: t("studyTerminology.kata.tensho.english", "Turning Palms"), explanation: t("studyTerminology.kata.tensho.explanation", "Soft circular movements contrasting with Sanchin's hardness") },
 { id: "kata-gekisai-dai-ichi", question: "Gekisai Dai Ichi", correctAnswer: t("studyTerminology.kata.gekisai-dai-ichi.english", "Attack and Smash Number One"), explanation: t("studyTerminology.kata.gekisai-dai-ichi.explanation", "First of the Gekisai kata, created by Chojun Miyagi") },
 { id: "kata-gekisai-dai-ni", question: "Gekisai Dai Ni", correctAnswer: t("studyTerminology.kata.gekisai-dai-ni.english", "Attack and Smash Number Two"), explanation: t("studyTerminology.kata.gekisai-dai-ni.explanation", "Second of the Gekisai kata, more advanced than Dai Ichi") },
 { id: "kata-saifa", question: "Saifa", correctAnswer: t("studyTerminology.kata.saifa.english", "Smash and Tear"), explanation: t("studyTerminology.kata.saifa.explanation", "One of the traditional kaishugata") },
 { id: "kata-seiyunchin", question: "Seiyunchin", correctAnswer: t("studyTerminology.kata.seiyunchin.english", "Control and Pull Battle"), explanation: t("studyTerminology.kata.seiyunchin.explanation", "Kata focusing on close combat techniques") },
 { id: "kata-shisochin", question: "Shisochin", correctAnswer: t("studyTerminology.kata.shisochin.english", "Four Direction Battle"), explanation: t("studyTerminology.kata.shisochin.explanation", "Kata with techniques in four directions") },
 { id: "kata-sanseru", question: "Sanseru", correctAnswer: t("studyTerminology.kata.sanseru.english", "Thirty-Six Hands"), explanation: t("studyTerminology.kata.sanseru.explanation", "Advanced kata with 36 techniques") },
 { id: "kata-seipai", question: "Seipai", correctAnswer: t("studyTerminology.kata.seipai.english", "Eighteen Hands"), explanation: t("studyTerminology.kata.seipai.explanation", "Advanced kata with 18 techniques") },
 { id: "kata-kururunfa", question: "Kururunfa", correctAnswer: t("studyTerminology.kata.kururunfa.english", "Holding Ground"), explanation: t("studyTerminology.kata.kururunfa.explanation", "Advanced kata emphasizing stability and power") },
 { id: "kata-seisan", question: "Seisan", correctAnswer: t("studyTerminology.kata.seisan.english", "Thirteen Hands"), explanation: t("studyTerminology.kata.seisan.explanation", "Advanced kata with 13 techniques") },
 { id: "kata-suparinpei", question: "Suparinpei", correctAnswer: t("studyTerminology.kata.suparinpei.english", "One Hundred and Eight Hands"), explanation: t("studyTerminology.kata.suparinpei.explanation", "The most advanced kata with 108 techniques") }
 ]
 },
 {
 ...
 difficulty: "intermediate",
 questions: [
 { id: "philosophy-goju", question: "Goju Ryu", correctAnswer: t("studyTerminology.philosophy.goju-ryu.english", "Hard-Soft Style"), explanation: t("studyTerminology.philosophy.goju-ryu.explanation", "The name means 'hard-soft style', combining hard and soft techniques") },
 { id: "philosophy-dojo-kun", question: "Dojo Kun", correctAnswer: t("studyTerminology.philosophy.dojo-kun.english", "Training Hall Precepts"), explanation: t("studyTerminology.philosophy.dojo-kun.explanation", "The five precepts that guide karate practice") },
 { id: "philosophy-karate-do", question: "Karate-do", correctAnswer: t("studyTerminology.philosophy.karate-do.english", "Way of the Empty Hand"), explanation: t("studyTerminology.philosophy.karate-do.explanation", "The martial art as a way of life, not just fighting") },
 { id: "philosophy-mind-body", question: "Mind-Body Unity", correctAnswer: t("studyTerminology.philosophy.mind-body-unity.english", "Shin-Gi-Tai"), explanation: t("studyTerminology.philosophy.mind-body-unity.explanation", "The unity of mind, technique, and body in training") },
 { id: "philosophy-respect", question: "Respect", correctAnswer: t("studyTerminology.philosophy.respect.english", "Rei"), explanation: t("studyTerminology.philosophy.respect.explanation", "Fundamental principle of respect in karate") },
 { id: "philosophy-perseverance", question: "Perseverance", correctAnswer: t("studyTerminology.philosophy.perseverance.english", "Nin"), explanation: t("studyTerminology.philosophy.perseverance.explanation", "Endurance and patience in training") },
 { id: "philosophy-etiquette", question: "Etiquette", correctAnswer: t("studyTerminology.philosophy.etiquette.english", "Reigi"), explanation: t("studyTerminology.philosophy.etiquette.explanation", "Proper behavior and manners in the dojo") },
 { id: "philosophy-character", question: "Character", correctAnswer: t("studyTerminology.philosophy.character.english", "Jinkaku"), explanation: t("studyTerminology.philosophy.character.explanation", "Building character through karate training") },
 { id: "philosophy-sincerity", question: "Sincerity", correctAnswer: t("studyTerminology.philosophy.sincerity.english", "Makoto"), explanation: t("studyTerminology.philosophy.sincerity.explanation", "Honesty and sincerity in practice") },
 { id: "philosophy-self-control", question: "Self-Control", correctAnswer: t("studyTerminology.philosophy.self-control.english", "Jisei"), explanation: t("studyTerminology.philosophy.self-control.explanation", "Controlling one's emotions and actions") }
 ]
 }
 ];
 ...
 explanation: t("study.questions.kata-basics-1.explanation", "The term means 'form' and refers to the choreographed patterns of movements.")
 },
 {
 id: "kata-basics-2",
 ...
 explanation: t("study.questions.kata-history-2.explanation", "The term means 'three battles' and refers to mind, body, and spirit.")
 },
 {
 id: "kata-history-3",
 ...
 explanation: t("study.questions.philosophy-1.explanation", "The term means 'hard-soft' and represents the balance of hard and soft techniques.")
 },
 {
 id: "philosophy-2",
 ...
 explanation: t("study.questions.techniques-2.explanation", "The term means 'block' or 'receive'.")
 },
 {
 id: "techniques-3",
 ...
 explanation: t("study.questions.kumite-1.explanation", "The term means 'sparring' or 'meeting of hands'.")
 },
 {
 id: "kumite-2",
