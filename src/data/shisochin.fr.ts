...
export const shisochinSteps: KataStep[] = [
  {
    id: 'step-1',
    number: 1,
    title: 'Introduction et signification de Shisochin',
    description: `Shisochin a été introduit à Okinawa par Kanryo Higaonna. Il a appris la kata de Ryu Ryu Ko. Le créateur original de la kata est inconnu. Shisochin signifie "quatre ouvertures" ou "quatre directions" et cela se réfère à l'exécution du shotei zuki (coup de paume) dans quatre directions.

Goju-ryu est le seul style de karaté avec cette kata. La kata est caractérisée par de nombreuses et puissantes techniques de main ouverte. Un bras avec une main ouverte peut être détendu plus facilement qu'avec un poing, permettant aux techniques d'être exécutées plus rapidement.`,
  },
  {
    id: 'step-2',
    number: 2,
    title: 'Nukite zuki et morote chudan shotei uke',
    description: `Depuis musubi dachi, vous vous enfoncez et faites un pas avec un mouvement circulaire avec la jambe droite dans sanchin dachi (les pieds sont, comme dans toutes les kaishugata, droits). Simultanément, les mains montent, glissent l'une sur l'autre au niveau du plexus solaire vers le côté et font un mouvement circulaire vers l'avant en passant les coudes dans morote chudan shotei uke.

Les mains sont plus verticales qu'horizontales. Les coudes sont près du corps (environ un poing de distance) et forment un angle de 90 degrés. Pendant le mouvement, le blocage et la frappe, vous devez imaginer un tigre traquant sa proie puis bondissant soudainement.`,
  },
  {
    id: 'step-3',
    number: 3,
    title: 'Exécution de Nukite zuki',
    description: `Donc vous vous déplacez lentement, circulairement (cheville le long de la cheville) et avec muchimi. Si vous êtes ancré, vous frappez soudainement avec un nukite zuki avec beaucoup de puissance, de vitesse et de précision. La main qui va frapper est d'abord tirée avec force dans votre côté, puis elle jaillit.
...
L'ude osae est initié depuis la poussée de la jambe et des hanches, les épaules et les hanches se déplacent ensemble, assurez-vous de ne pas utiliser la force musculaire de vos épaules ou de vos bras. La tête tourne initialement avec le corps mais garde le regard vers l'avant.`,
  },
  {
    ...
    description: `Amenez votre poids sur votre pied gauche et fermez les deux pieds ensemble (heisoku dachi). Bien sûr, c'est une posture d'entraînement pour gagner plus d'équilibre. Pendant le mouvement vers heisoku dachi, vous inspirez et fermez votre bassin en l'inclinant vers l'arrière.
