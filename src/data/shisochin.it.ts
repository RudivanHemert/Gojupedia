...
export const shisochinSteps: KataStep[] = [
  {
    id: 'step-1',
    number: 1,
    title: 'Introduzione e significato di Shisochin',
    description: `Shisochin è stato introdotto a Okinawa da Kanryo Higaonna. Ha imparato la kata da Ryu Ryu Ko. Il creatore originale della kata è sconosciuto. Shisochin significa "quattro aperture" o "quattro direzioni" e questo si riferisce all'esecuzione dello shotei zuki (colpo di palma) in quattro direzioni.

Goju-ryu è l'unico stile di karate con questa kata. La kata è caratterizzata da molte e potenti tecniche di mano aperta. Un braccio con una mano aperta può essere rilassato più facilmente che con un pugno, permettendo alle tecniche di essere eseguite più velocemente.`,
  },
  {
    id: 'step-2',
    number: 2,
    title: 'Nukite zuki e morote chudan shotei uke',
    description: `Da musubi dachi, ti abbassi e fai un passo con un movimento circolare con la gamba destra in sanchin dachi (i piedi sono, come in tutte le kaishugata, dritti). Simultaneamente, le mani salgono, scivolano una sull'altra a livello del plesso solare verso il lato e fanno un movimento circolare in avanti passando i gomiti in morote chudan shotei uke.

Le mani sono più verticali che orizzontali. I gomiti sono vicini al corpo (circa un pugno di distanza) e formano un angolo di 90 gradi. Durante il movimento, blocco e colpo, devi immaginare una tigre che insegue la sua preda e poi salta improvvisamente.`,
  },
  {
    id: 'step-3',
    number: 3,
    title: 'Esecuzione di Nukite zuki',
    description: `Quindi ti muovi lentamente, circolarmente (caviglia lungo caviglia) e con muchimi. Se sei radicato, colpisci improvvisamente con un nukite zuki con molta forza, velocità e precisione. La mano che sta per colpire viene prima tirata con forza nel tuo fianco, poi salta fuori.
...
L'ude osae è iniziato dalla spinta della gamba e delle anche, le spalle e le anche si muovono insieme, assicurati di non usare forza muscolare dalle tue spalle o braccia. La testa inizialmente gira con il corpo ma mantiene lo sguardo in avanti.`,
  },
  {
    ...
    description: `Porta il tuo peso sul tuo piede sinistro e chiudi entrambi i piedi insieme (heisoku dachi). Naturalmente, questa è una posizione di pratica per guadagnare più equilibrio. Durante il movimento verso heisoku dachi, inspiri e chiudi il tuo bacino inclinandolo all'indietro.
