          ...
          <div className="md:flex md:space-x-4">
            <div className="md:w-2/3 space-y-4">
              ...
              <div className="md:hidden float-right ml-4 mb-2">
                <img 
                  src="https://images.unsplash.com/photo-1609710228159-0fa9bd7c0827?q=80&w=1974&auto=format&fit=crop" 
                  alt="Karate Master" 
              ...
              <h3 className="text-xl font-semibold mt-4">Beginnings</h3>
              <p className="text-gray-700">
              ...
              <div className="md:hidden float-left mr-4 mb-2 mt-2">
                <img 
                  src="https://images.unsplash.com/photo-1555597673-b21d5c935865?q=80&w=1974&auto=format&fit=crop" 
                  alt="Karate Training" 
                  className="w-40 rounded-md shadow-md"
                />
              </div>
              ...
              <h3 className="text-xl font-semibold mt-4">Move to the United States of America</h3>
              <p className="text-gray-700">
              ...
              <h3 className="text-xl font-semibold mt-4">Back to Japan</h3>
              <p className="text-gray-700">
              ...
              <h3 className="text-xl font-semibold mt-4">Only the Traditional Path</h3>
              <p className="text-gray-700">
            ...
            <div className="hidden md:block md:w-1/3 space-y-4">
              <div className="sticky top-4">
                ...
                />
                <img 
                  src="https://images.unsplash.com/photo-1599580326852-a633c16dc58b?q=80&w=1974&auto=format&fit=crop" 
                  alt="Traditional Goju-ryu Training" 
